  ...
  return knex('Places').del()
    .then(function () {
      ...
      return knex('Places').insert([
        ...
        {id: 2, place: 'Karikari Pennisula', date: '20/11/2015', description: 'Matai Bay, Puheke Beach', image: 'https://media-cdn.tripadvisor.com/media/photo-s/0a/a7/63/3d/taumarumaru-reserve-in.jpg', lat:'-36.8547512', lng:'175.77874250000002'},
        ...
        {id: 4, place: '90 Mile Beach', date: '19/11/2015', description: 'Giant Te Paki', image: 'https://media-cdn.tripadvisor.com/media/photo-s/0a/a7/63/3d/taumarumaru-reserve-in.jpg', lat:'-36.8547512', lng:'177.77874250000002'},
        {id: 5, place: 'Kawakawa', date: '21/11/2015', description: 'Hundertwasser toilet', image: 'https://media-cdn.tripadvisor.com/media/photo-s/0a/a7/63/3d/taumarumaru-reserve-in.jpg', lat:'-36.8547512', lng:'178.77874250000002'}
